...
abstract class MapMapGeneratorBase<TMapMap extends MapMapBase>
    extends GeneratorForAnnotation<TMapMap> {
  ClassElement? _classElement;
  String? _className;

  TMapMap hydrateAnnotation(ConstantReader reader);
...
Iterable<FieldDescriptor> _getFieldDescriptors(
    ClassElement classElement, MapMapBase annotation) {
