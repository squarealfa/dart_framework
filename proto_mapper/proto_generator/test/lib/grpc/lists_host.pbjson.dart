...
const GListsHost$json = const {
  ...
  '2': const [
    ...
    const {'1': 'nvboolsHasValue', '3': 3, '4': 1, '5': 8, '10': 'nvboolsHasValue'},
    const {'1': 'vstrings', '3': 4, '4': 3, '5': 9, '10': 'vstrings'},
    const {'1': 'nvstrings', '3': 5, '4': 3, '5': 9, '10': 'nvstrings'},
    const {'1': 'nvstringsHasValue', '3': 6, '4': 1, '5': 8, '10': 'nvstringsHasValue'},
    const {'1': 'vdurations', '3': 7, '4': 3, '5': 1, '10': 'vdurations'},
    const {'1': 'nvdurations', '3': 8, '4': 3, '5': 1, '10': 'nvdurations'},
    const {'1': 'nvdurationsHasValue', '3': 9, '4': 1, '5': 8, '10': 'nvdurationsHasValue'},
    const {'1': 'vdatetimes', '3': 10, '4': 3, '5': 3, '10': 'vdatetimes'},
    const {'1': 'nvdatetimes', '3': 11, '4': 3, '5': 3, '10': 'nvdatetimes'},
    const {'1': 'nvdatetimesHasValue', '3': 12, '4': 1, '5': 8, '10': 'nvdatetimesHasValue'},
    const {'1': 'vdecimals', '3': 13, '4': 3, '5': 9, '10': 'vdecimals'},
    const {'1': 'nvdecimals', '3': 14, '4': 3, '5': 9, '10': 'nvdecimals'},
    const {'1': 'nvdecimalsHasValue', '3': 15, '4': 1, '5': 8, '10': 'nvdecimalsHasValue'},
    const {'1': 'vints', '3': 16, '4': 3, '5': 5, '10': 'vints'},
    const {'1': 'nvints', '3': 17, '4': 3, '5': 5, '10': 'nvints'},
    const {'1': 'nvintsHasValue', '3': 18, '4': 1, '5': 8, '10': 'nvintsHasValue'},
    const {'1': 'vdoubles', '3': 19, '4': 3, '5': 1, '10': 'vdoubles'},
    const {'1': 'nvdoubles', '3': 20, '4': 3, '5': 1, '10': 'nvdoubles'},
    const {'1': 'nvdoublesHasValue', '3': 21, '4': 1, '5': 8, '10': 'nvdoublesHasValue'},
    const {'1': 'vapplianceTypes', '3': 22, '4': 3, '5': 14, '6': '.GApplianceType', '10': 'vapplianceTypes'},
    const {'1': 'nvapplianceTypes', '3': 23, '4': 3, '5': 14, '6': '.GApplianceType', '10': 'nvapplianceTypes'},
    const {'1': 'nvapplianceTypesHasValue', '3': 24, '4': 1, '5': 8, '10': 'nvapplianceTypesHasValue'},
  ],
};
