...
import 'package:mongodb_repository/mongodb_repository.dart';
...
void main() async {
  ...
  final repository = MongoDbRepository<Recipe>(testDbClient, _testCollection);
...
Future _ensureEmptyTestCollection(
    Db testDbClient, String testCollection) async {
...
Future<Db> _connectTestDb() async {
  throw UnimplementedError();
